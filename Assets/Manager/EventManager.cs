...
{
    //public static Action<int> OnCheckMoney;


    //public static void TriggerOnCheckMoney(int gold)
    //{
    ...
    //public static void TriggerOnLoadMainScene()
    //{
    //    if (OnLoadMainScene != null)
    //    {
    //        OnLoadMainScene();
    ...
    //public static void TriggerOnLoadPreparationScene()
    //{
    ...
    //public static void TriggerOnLoadPlayScene()
    //{
